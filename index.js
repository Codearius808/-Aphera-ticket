...
.setColor("127896")
.setAuthor({ name: `VRP | OTO SANATKARLAR | Destek Sistemi`, iconURL: as.guild.iconURL({ dynamic: true }) })
...
.addFields(
     ...
     { name: "☢️ Mekanik'i Kural Dışı Kullanma Bildirimi ", value: "Biri altyapımızı çaldıysa onu sunucudan yasaklatabilirsin.", inline: true },
     { name: "🛎️ Öneri, İstek Bildirimi ", value: "Bir kullanıcıyı bildirirsin.", inline: true },
 )
...
if(interaction.customId === "destek") {
  ...
  .addComponents(
    ...
    .setCustomId("Mekanik'i Kural Dışı Kullanma Bildirimi"),
    new Discord.ButtonBuilder()
    .setEmoji("🛎️")
    .setStyle(Discord.ButtonStyle.Danger)
    .setCustomId("Öneri, İstek Bildirimi"),
...
const butonlar = ["Çekiliş Kazandım","Mekanik'i Kural Dışı Kullanma Bildirimi","Öneri,İstek Bildirimi"]
...
const embed = new EmbedBuilder()
.setAuthor({name: "'Aphera - Destek Sistemi!", iconURL: interaction.guild.iconURL()})
